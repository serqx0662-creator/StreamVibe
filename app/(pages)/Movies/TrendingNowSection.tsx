...
export default function TrendingNowSection() {
    ...
    const BULLET_COUNT = 5; // Ограничиваем количество точек до 5
    ...
    return (
        <section className="bg-[#0F0F0F] px-4 md:px-10 lg:px-20 py-3 sm:py-7 lg:py-10">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-8 md:mb-12 gap-6">
                ...
                {/* Навигация — СКРЫВАЕМ на мобилках полностью */}
                                    ...
                                    <CardContent className="p-0 flex flex-col h-full">
                                        <div className="relative aspect-[2/3] overflow-hidden rounded-xl mb-4 bg-[#262626] shadow-lg">
                                            ...
                                            <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                                <div className="w-12 h-12 bg-[#E50000] flex items-center justify-center rounded-full border-none shadow-xl scale-90 group-hover:scale-100 transition-transform">
                                        ...
                                        <h3 className="text-white text-sm md:text-base group-hover:text-[#E50000] font-semibold truncate">
                                            {movie.title}
                                        </h3>
                                    </CardContent>
                                </Card>
