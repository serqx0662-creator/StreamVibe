                ...
                >
                    ...
                    <div className="absolute bottom-6 md:bottom-12 left-0 right-0 z-20 px-6 md:px-12 flex justify-between items-center pointer-events-none">
                        <Button
                            variant="ghost"
                            size="icon"
                            className="hero-prev hover:text-white pointer-events-auto w-10 h-10 md:w-12 md:h-12 bg-black/20 backdrop-blur-md border border-[#262626] text-white rounded-lg hover:bg-black/40"
                        >
                            <ArrowLeft size={20} />
                        </Button>


                        <div className="hero-pagination pointer-events-auto flex items-center gap-1.5 absolute left-1/2 -translate-x-1/2" />

                        <Button
                            variant="ghost"
                            size="icon"
                            className="hero-next hover:text-white pointer-events-auto w-10 h-10 md:w-12 md:h-12 bg-black/20 backdrop-blur-md border border-[#262626] text-white rounded-lg hover:bg-black/40"
                        >
                            <ArrowRight size={20} />
                        </Button>
                    </div>
