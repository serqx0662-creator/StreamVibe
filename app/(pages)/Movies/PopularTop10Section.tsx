    ...
    return (
        <section className="bg-[#0F0F0F] px-4 md:px-10 lg:px-20 py-10">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-8 md:mb-12 gap-6">
                ...
                <div className="flex items-center gap-2 md:gap-3 bg-[#0A0A0A] border border-[#1A1A1A] p-2 rounded-xl">
                    <Button
                        variant="ghost"
                        size="icon"
                        className="top10-prev-btn w-9 h-9 md:w-11 md:h-11 text-white bg-[#141414] border border-[#262626] hover:bg-[#1F1F1F] hover:text-white rounded-lg transition-all"
                    >
                        <ArrowLeft className="w-5 h-5" />
                    </Button>

                    <div className="top10-pagination flex items-center gap-1 px-1 md:px-2" />

                    <Button
                        variant="ghost"
                        size="icon"
                        className="top10-next-btn w-9 h-9 md:w-11 md:h-11 text-white bg-[#141414] border border-[#262626] hover:bg-[#1F1F1F] hover:text-white rounded-lg transition-all"
                    >
            ...
            <Swiper
                ...
                slidesPerView={1.5}
                slidesPerGroup={1}
                navigation={{ prevEl: '.top10-prev-btn', nextEl: '.top10-next-btn' }}
                pagination={{
                    el: '.top10-pagination',
                    clickable: true,
                    renderBullet: (index, className) => index < 5 ? `<span class="${className} top10-bullet"></span>` : "",
                }}
                breakpoints={{
